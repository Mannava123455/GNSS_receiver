...
#./gps-sdr-sim -e brdc0010.22n  -s 5456000 -b 1 -d 40 -l 40,90,100
./gps-sdr-sim -e brdc0010.22n  -s 2048000 -b 1 -d 40 -l 40,90,100
...
./fsgps -s  2048000 -i 1000000 iq_if.bin  > log.txt
