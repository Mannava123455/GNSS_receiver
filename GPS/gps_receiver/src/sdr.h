...
#define ACQSTEP       500              /* doppler search frequency step (Hz) */
...
#define NAVFLEN_ISS     300            /* navigation frame data (bits) */
#define NAVADDFLEN_ISS  2              /* additional bits of frame (bits) */
#define NAVPRELEN_ISS   8             /* preamble bits length (bits) */
#define NAVEPHCNT_ISS   3              /* number of eph. contained frame */
...
typedef struct {
    ...
    double FLL_nco;      // i was added
    double PLL_nco;      // i was added
