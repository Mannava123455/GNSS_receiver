...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[] \textbf{if} max$\_$of$\_$max  $>$ max$\_$peak$\_$to$\_$noise$\_$ratio[\textbf{i}]
        \begin{enumerate}
            \item[] \textbf{for} \textbf{j} = 4 to \textbf{j} = \textbf{i}-1
            \begin{itemize}
                \item[] max$\_$peak$\_$to$\_$noise$\_$ratio[\textbf{j}] = max$\_$peak$\_$to$\_$noise$\_$ratio[\textbf{j}-1]
            ...
            \end{itemize} 
            \item[] \textbf{end for}
            \item[] max$\_$peak$\_$to$\_$noise$\_$ratio[\textbf{i}] =  max$\_$of$\_$max 
