...
#ifdef NAVIC_L1
/*! \brief NavIC L1 Carrier frequency */
...
#ifdef NAVIC_L5
/*! \brief NavIC L5 Carrier frequency */
#define CARR_FREQ (1176.45e6)
#define CARR_TO_CODE (1.0/1150.0)
#define LAMBDA 0.254828048790854
#endif

#ifdef NAVIC_S
/*! \brief NavIC S Carrier frequency */
#define CARR_FREQ (2492.028e6)
#define CARR_TO_CODE (1.0/2436.0)
