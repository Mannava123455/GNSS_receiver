...
class read(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "navicrx1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("navicrx1")
        ...
        self.ch_freq = ch_freq = 1176.42e6
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, 'Navic_Q_samp_120sec.bin', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'Navic_I_samp_120sec.bin', False)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_complex_to_imag_0, 0), (self.blocks_file_sink_0_0, 0))
